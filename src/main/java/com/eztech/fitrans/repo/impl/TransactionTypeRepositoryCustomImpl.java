...
public class TransactionTypeRepositoryCustomImpl extends BaseCustomRepository<TransactionType> implements TransactionTypeRepositoryCustom {
    ...
    public String buildQuery(Map<String, Object> paramSearch, Map<String, Object> parameters, boolean count) {
        ...
        if (paramNotNullOrEmpty(paramSearch, "txtSearch")) {
            sb.append(" AND (UPPER(os.name) LIKE :txtSearch OR UPPER(os.type) LIKE :txtSearch) ");
        ...
        if (paramNotNullOrEmpty(paramSearch, "name")) {
            ...
            parameters.put("cif", formatLike((String) paramSearch.get("name")).toUpperCase());
        }
        ...
        if (paramNotNullOrEmpty(paramSearch, "note")) {
            sb.append(" AND os.note = :note ");
            parameters.put("note", paramSearch.get("note"));
        }
