...
import com.eztech.fitrans.repo.PriorityCardRepositoryCustom;
...
public class PriorityCardRepositoryCustomImpl extends BaseCustomRepository<PriorityCard> implements
        PriorityCardRepositoryCustom {
    ...
    public List search(Map searchDTO, Class aClass) {
        ...
        return getResultList(sql, PriorityCard.class, parameters);
    }
    ...
    public Integer updateStatus(Long id, String status, String lastUpdatedBy,
        ...
        Map<String, Object> parameters = new HashMap<>();
        sb.append(
                "UPDATE priority_card SET status =:status, last_updated_by = :updateBy,last_updated_date=:updateDate WHERE id = :id ");
    ...
    public Boolean checkExits(Long id, String code) {
        StringBuilder sb = new StringBuilder();
        Map<String, Object> parameters = new HashMap<>();
        sb.append("SELECT COUNT(*) FROM priority_card WHERE 1=1 ");
    ...
    public String buildQuery(Map<String, Object> paramSearch, Map<String, Object> parameters,
        ...
        if (paramNotNullOrEmpty(paramSearch, "txtSearch")) {
            sb.append(" AND (UPPER(os.code) LIKE :txtSearch OR UPPER(os.name) LIKE :txtSearch OR UPPER(os.description) LIKE :txtSearch) ");
