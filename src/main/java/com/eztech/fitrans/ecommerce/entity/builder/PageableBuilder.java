...
import com.eztech.fitrans.ecommerce.entity.enums.SortOrder;
...
public class PageableBuilder {
    ...
    public Pageable build(BaseFilter filter) {
        ...
        // tune sort by country name
        sortField = sortField != null && sortField.equals(COUNTRY) ? sortField.concat(".name") : sortField;
