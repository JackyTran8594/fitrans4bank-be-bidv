...
import static com.eztech.fitrans.common.Const.RESULT.PROCESS_RETURN_SUCCESS;
import static com.eztech.fitrans.common.Const.TASK_VARIABLE.SUCCESS;
...
public class CamundaService {
    ...
    public void checkResult(String processInstanceId){
        ...
        if (!PROCESS_RETURN_SUCCESS.equalsIgnoreCase(isSuccess.getValue().toString())) {
            HistoricVariableInstance message = getHistoricVariableByName(processInstanceId, Const.TASK_VARIABLE.MESSAGE);
